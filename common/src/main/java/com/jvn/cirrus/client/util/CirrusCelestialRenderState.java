...
public final class CirrusCelestialRenderState {
    ...
    public static void captureSun(Matrix4f modelView) {
        if (!externalSun) {
            captureSunModelView(modelView);
        }
    }

    public static void captureExternalSun(Matrix4f modelView) {
        captureSunModelView(modelView);
        externalSun = true;
    }

    public static boolean hasExternalSun() {
        return externalSun;
    }

    private static void captureSunModelView(Matrix4f modelView) {
