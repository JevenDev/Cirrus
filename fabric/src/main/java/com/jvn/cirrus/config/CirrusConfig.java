...
public final class CirrusConfig {
    ...
    public static final CirrusConfigSpec.DoubleValue LIGHTNING_BOLT_INTENSITY;
    public static final CirrusConfigSpec.BooleanValue HIDE_LIGHTNING_CLOUD_FLASHES;
    public static final CirrusConfigSpec.DoubleValue LIGHTNING_CLOUD_FLASH_OPACITY;
    public static final CirrusConfigSpec.EnumValue<CloudStyle> LOWER_LAYER_STYLE;
    public static final CirrusConfigSpec.DoubleValue LOWER_LAYER_HEIGHT_OFFSET;
    public static final CirrusConfigSpec.DoubleValue LOWER_LAYER_SPEED;
    public static final CirrusConfigSpec.DoubleValue LOWER_LAYER_OPACITY;
    public static final CirrusConfigSpec.BooleanValue UPPER_LAYER_ENABLED;
    public static final CirrusConfigSpec.EnumValue<CloudStyle> UPPER_LAYER_STYLE;
    public static final CirrusConfigSpec.DoubleValue UPPER_LAYER_HEIGHT_OFFSET;
    public static final CirrusConfigSpec.DoubleValue UPPER_LAYER_SPEED;
    public static final CirrusConfigSpec.DoubleValue UPPER_LAYER_OPACITY;
    public static final CirrusConfigSpec.BooleanValue TOP_LAYER_ENABLED;
    public static final CirrusConfigSpec.EnumValue<CloudStyle> TOP_LAYER_STYLE;
    public static final CirrusConfigSpec.DoubleValue TOP_LAYER_HEIGHT_OFFSET;
    public static final CirrusConfigSpec.DoubleValue TOP_LAYER_SPEED;
    ...
    public static final CirrusConfigSpec.DoubleValue STAR_MAX_OPACITY;
    public static final CirrusConfigSpec.DoubleValue STAR_MIN_SIZE;
    public static final CirrusConfigSpec.DoubleValue STAR_MAX_SIZE;
    public static final CirrusConfigSpec.DoubleValue STAR_TWINKLE_STRENGTH;
    public static final CirrusConfigSpec.DoubleValue STAR_TWINKLE_SPEED;
    public static final CirrusConfigSpec.DoubleValue STAR_COLOR_VARIATION;
    public static final CirrusConfigSpec.BooleanValue SHOOTING_STARS_ENABLED;
    public static final CirrusConfigSpec.BooleanValue SHOOTING_STAR_PIXELATED_TRAIL;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_FREQUENCY;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_OPACITY;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_MIN_SIZE;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_MAX_SIZE;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_MIN_SPEED;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_MAX_SPEED;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_SPEED_VARIATION;
    public static final CirrusConfigSpec.DoubleValue SHOOTING_STAR_TRAIL_LENGTH;
    ...
    public static final CirrusConfigSpec.IntValue MORNING_HORIZON_COLOR;
    public static final CirrusConfigSpec.IntValue MORNING_ZENITH_COLOR;
    public static final CirrusConfigSpec.DoubleValue MORNING_GRADIENT_STRENGTH;
    public static final CirrusConfigSpec.IntValue DAY_HORIZON_COLOR;
    public static final CirrusConfigSpec.IntValue DAY_ZENITH_COLOR;
    public static final CirrusConfigSpec.DoubleValue DAY_GRADIENT_STRENGTH;
    public static final CirrusConfigSpec.IntValue EVENING_HORIZON_COLOR;
    public static final CirrusConfigSpec.IntValue EVENING_ZENITH_COLOR;
    public static final CirrusConfigSpec.DoubleValue EVENING_GRADIENT_STRENGTH;
    public static final CirrusConfigSpec.IntValue NIGHT_HORIZON_COLOR;
    public static final CirrusConfigSpec.IntValue NIGHT_ZENITH_COLOR;
    public static final CirrusConfigSpec.DoubleValue NIGHT_GRADIENT_STRENGTH;
    public static final CirrusConfigSpec.BooleanValue MILKY_WAY_ENABLED;
    public static final CirrusConfigSpec.BooleanValue MILKY_WAY_PIXELATION_ENABLED;
    public static final CirrusConfigSpec.IntValue MILKY_WAY_PIXELATION_RESOLUTION;
    public static final CirrusConfigSpec.DoubleValue MILKY_WAY_OPACITY;
    public static final CirrusConfigSpec.BooleanValue AURORA_ENABLED;
    public static final CirrusConfigSpec.BooleanValue AURORA_PIXELATION_ENABLED;
    ...
    public static final CirrusConfigSpec.DoubleValue END_SKY_INTENSITY;
    public static final CirrusConfigSpec.DoubleValue END_SKY_ANIMATION_SPEED;
    public static final CirrusConfigSpec.DoubleValue END_SKY_MORPH_SPEED;
    public static final CirrusConfigSpec.DoubleValue END_SKY_VOID_COVERAGE;
    public static final CirrusConfigSpec.DoubleValue END_SKY_VOID_DARKNESS;
    public static final CirrusConfigSpec.DoubleValue END_SKY_LIGHTNING_FREQUENCY;
    public static final CirrusConfigSpec.DoubleValue END_SKY_LIGHTNING_INTENSITY;
    public static final CirrusConfigSpec.DoubleValue END_SKY_SURGE_FREQUENCY;
    public static final CirrusConfigSpec.DoubleValue END_SKY_SURGE_STRENGTH;
    public static final CirrusConfigSpec SPEC;

    static {
        CirrusConfigSpec.Builder builder = new CirrusConfigSpec.Builder();
    ...
    private static CirrusConfigSpec.IntValue defineColor(
            CirrusConfigSpec.Builder builder,
            String name,
            int defaultValue,
            String comment
    ) {
    ...
    public record IntSetting(int defaultValue, int minimum, int maximum, int step) {
        private CirrusConfigSpec.IntValue define(CirrusConfigSpec.Builder builder, String name, String comment) {
    ...
    public record DoubleSetting(double defaultValue, double minimum, double maximum, double step) {
        private CirrusConfigSpec.DoubleValue define(CirrusConfigSpec.Builder builder, String name, String comment) {
            return builder.comment(comment).defineInRange(name, defaultValue, minimum, maximum);
        }
    }
}
