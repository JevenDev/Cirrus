...
public final class CirrusConfigScreen {
    ...
    private static Option<Boolean> booleanOption(String key, CirrusConfigSpec.BooleanValue value) {
        return booleanOption(key, value, description(key));
    }

    private static Option<Boolean> booleanOption(
            String key,
            CirrusConfigSpec.BooleanValue value,
    ...
    private static <E extends Enum<E>> Option<E> enumOption(
            String key,
            CirrusConfigSpec.EnumValue<E> value,
            Class<E> enumClass,
    ...
    private static Option<Color> colorOption(String key, CirrusConfigSpec.IntValue value) {
    ...
    private static Option<Integer> integerOption(
            String key,
            CirrusConfigSpec.IntValue value,
    ...
    private static Option<Double> doubleOption(
            String key,
            CirrusConfigSpec.DoubleValue value,
