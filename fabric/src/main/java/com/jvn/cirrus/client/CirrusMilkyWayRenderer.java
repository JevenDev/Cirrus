...
public final class CirrusMilkyWayRenderer implements AutoCloseable {
    ...
    public void render(
        ...
        float nightStrength = Mth.clamp(CirrusRenderContext.starBrightness(level, partialTick) * 1.6F, 0.0F, 1.0F);
        ...
        prepareDome();
        CirrusShader shader = CirrusShaders.milkyWay();
        ...
        CirrusShaderUniforms.setUniform(shader, "CirrusSkyGradientIntensity", skyGradientIntensity);
        CirrusShaderUniforms.setUniform(
